...
use windows_sys::Win32::{
    ...
    System::Threading::{
        GetExitCodeProcess, GetProcessId, RegisterWaitForSingleObject,
        UnregisterWait, INFINITE, WT_EXECUTEINWAITTHREAD, WT_EXECUTEONLYONCE,
    },
};
...
mod tests {
    use std::{
        os::windows::io::AsRawHandle, process::Command, sync::Arc,
        time::Duration,
    };
